...
const MOCK_RESORTS: Resort[] = [
  {
    ...
    roomTypes: [
      {
        ...
        maxOccupancy: 4,
        occupancy: { adults: 2, kids: 2 },
        rateSample: 450,
        is2Bedroom: false,
        image: 'https://images.unsplash.com/photo-1613395877344-13d4a8e0b49d',
      },
      {
        id: 'rc2',
        resortId: 'r1',
    ...
    internalRatings: [
      { id: 'ir1', resortId: 'r1', rating: 5, reviewer: 'Ops', notes: 'Excellent', date: '2024-01-15' },
    ],
    partners: [
      { id: 'p1', name: 'Luxe Partners', contactInfo: 'partners@luxe.com', role: 'General Manager', email: 'gm@luxe.com', phone: '+30 123 456 7890' },
    ],
    supplierContacts: [
      { id: 'p1', name: 'Luxe Partners', role: 'General Manager', email: 'gm@luxe.com', phone: '+30 123 456 7890', notes: 'Primary contact' },
    ],
  ...
  },
  {
    ...
    roomTypes: [
      { id: 'rc3', resortId: 'r2', name: 'Cave Suite', bedConfig: '1 King', maxOccupancy: 2, occupancy: { adults: 2 }, rateSample: 380, is2Bedroom: false },
      { id: 'rc4', resortId: 'r2', name: 'Family Suite', bedConfig: '2 King', maxOccupancy: 4, occupancy: { adults: 4 }, rateSample: 890, is2Bedroom: true },
    ],
    seasonality: [{ id: 's2', resortId: 'r2', startMonth: 4, endMonth: 10, notes: 'Apr–Oct' }],
    media: [],
    perks: ['Breakfast', 'Infinity pool', 'Concierge'],
    internalRatings: [{ id: 'ir2', resortId: 'r2', rating: 4, reviewer: 'Ops', notes: 'Great views', date: '2024-02-01' }],
    partners: [],
